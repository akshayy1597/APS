from dotenv import load_dotenv #to read the URL of the mongodb database 
import pymongo
from sensor.constant.database import DATABASE_NAME
import certifi
ca = certifi.where()
from sensor.constant.env1_variable import MONGODB_URL_KEY
import os 
import logging 

load_dotenv()
class MongoDBClient:
    client = None #this is just a class variable
