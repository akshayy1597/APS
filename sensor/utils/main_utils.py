#the utils file is to read the yaml file and write the yaml file 
#utils file is also used to write a generic code where it can be used throughout the project and 
# doesn't need to write the code again n again everywhere 
import yaml
import pandas as pd
import numpy as np
import os
...
def read_yaml_file(file_path:str)->dict:
    try:
        ...
        with open(file_path, 'rb') as yaml_file:
            return yaml.safe_load(yaml_file)    #safe_load this func helps us to read the yaml file in a safe way 
